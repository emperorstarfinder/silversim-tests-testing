...
namespace SilverSim.Tests.Http2.Post.Expect100Continue.AfterRequestBody
{
    public sealed class Error401Test : ITest
    {
        ...
        public bool Run()
        {
            ...
            for (m_SendStatusCode = HttpStatusCode.MultipleChoices; m_SendStatusCode < HttpStatusCode.HttpVersionNotSupported; ++m_SendStatusCode)
            {
                ...
                try
                {
                    ...
                    {
                        TimeoutMs = 60000,
                        ConnectionMode = HttpClient.ConnectionModeEnum.Http2PriorKnowledge,
                        Headers = headers,
                        Expect100Continue = true,
                        DisableExceptions = HttpClient.Request.DisableExceptionFlags.DisableUnauthorized
                ...
                {
                    if(e.GetHttpCode() == (int)HttpStatusCode.NotFound || e.GetHttpCode() == (int)HttpStatusCode.Unauthorized)
                    {

...
{
    public sealed class CheckRequiredLegacyApiExistenceTest : ITest
    {
        ...
        public bool Run()
        {
            m_Log.Info("Check that service implements legacy API");
            return m_InventoryService.SupportsLegacyFunctions;
        }
    }
}